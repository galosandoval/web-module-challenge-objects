...
// console.log(createMenuItem('Breakfast Burrito', 8, 'Breakfast'));
...
console.log(addReview(reviews, 'Galo', 10, 'Would recommend, ten out of ten.'));
...
function getLastReview(array) {
  ...
  let review = `${name} gave the restaurant a ${rating}, and their feedback was: ${feedback}`;
  return review;
  }
